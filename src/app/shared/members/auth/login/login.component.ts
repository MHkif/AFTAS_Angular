...
import { AuthEmailPassword } from 'src/app/models/auth_email_password.model';
import { HttpRes } from 'src/app/models/httpRes.model';
import { UserService } from 'src/app/services/memeber/user.service';
import { AppState } from 'src/app/store/state/app.state';
import { startLoginAction } from 'src/app/store/user/user.action';
import { UserAuthState } from 'src/app/store/user/user.state';
...
export class LoginComponent {
  ...
  constructor(private builder: FormBuilder, private userService: UserService, private store: Store<AppState>) {}
  ngOnInit(): void {
